...
import { settings, setAutoThemeChangeCallback } from './settings'
import { updateAutoThemeEnabled } from './auto-theme'
...
app.whenReady().then(() => {
  ...
  createWindow()
  setAutoThemeChangeCallback(updateAutoThemeEnabled)
  updateAutoThemeEnabled(settings.autoTheme)
