    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          disabled={disabled}
          className={cn(
            'w-60 justify-between border-[var(--app-control-border)] bg-[var(--app-control-bg)] text-[var(--app-text)] hover:bg-[var(--app-control-hover-bg)]',
            className
          )}
        >
      ...
      <PopoverContent className="w-60 border-[var(--app-control-border)] bg-[var(--app-panel-bg)] p-0 text-[var(--app-text)]">
        <Command className="bg-transparent text-[var(--app-text)]">
          <CommandInput
              ...
              {filtered.map((m) => (
                <div key={m.value} className="group flex">
                  <CommandItem
                    ...
                    className="flex-1 data-[selected=true]:bg-[var(--app-control-hover-bg)] data-[selected=true]:text-[var(--app-text)]"
                  >
                    {m.label}
                    <Check
                  ...
                  {m.isCustom && (
                    <div className="hidden group-hover:flex">
                      <button
                        className="text-[var(--app-text-muted)] hover:text-red-500 cursor-pointer"
