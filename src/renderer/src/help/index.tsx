import { Lightbulb, MessageCircle, Camera, PictureInPicture2, EyeOff, Info } from 'lucide-react'
    ...
    <>
      ...
      <div id="app-content" className="flex flex-col gap-4 p-8">
        ...
        <HelpSection Icon={Info} title="简介">
          ...
          <div className="bg-[var(--app-panel-bg)] rounded-lg p-4">
            <h3 className="font-semibold mb-2">主要功能：</h3>
            <ul className="space-y-1 text-[var(--app-text)] list-disc list-inside">
        ...
        <HelpSection Icon={MessageCircle} title="联系支持">
          <p className="text-[var(--app-text)]">如果您遇到问题或有建议，请通过以下方式联系我们：</p>
